...
export default function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Dummy login, just route to dashboard
    navigate('/dashboard');
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="flex justify-center inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-primary-600 text-white shadow-lg mx-auto mb-4">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Predictive Food Demand & Smart Redistribution System
        </p>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 border-t-[6px] border-primary-600 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  placeholder="admin@intelliserve.ai"
                />
              </div>
            </div>
